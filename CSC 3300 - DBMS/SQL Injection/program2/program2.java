...
public class program2
{
    public static void main(String args[])
    {
        try
        {
            ...
            PreparedStatement prepStatement = connect.prepareStatement("insert into students(TNumber, FirstName, LastName, DateOfBirth) values ('00003256', 'John', 'Doe', '19700715'), ('00001423', 'Mary', 'Smith', '19920101'), ('00015366', 'William', 'Williamson', '19910523'), ('00012345', 'Katie', 'Did', '19920927')");
