...
printMatrix([Head|Tail]) :- print(Head), print('\n'), printMatrix(Tail).
...
sudoku4x4(Puzzle, Solution) :-
    ...
    printMatrix([Row1, Row2, Row3, Row4]).
...
sudoku6x6(Puzzle, Solution) :-
    ...
    printMatrix([Row1, Row2, Row3, Row4, Row5, Row6]).
...
sudoku9x9(Puzzle, Solution) :-
    ...
    printMatrix([Row1, Row2, Row3, Row4, Row5, Row6, Row7, Row8, Row9]).
