...
public class AVLDriver
{
   public static void main(String[] args)
   {
      //call the height and isBalanced methods and display the results with all items inserted
       ...
       Test.execute(worst);
       ArrayList<CD> wcds = worst.getWorstCDs();
       
       System.out.println("worst CDs:");
       Iterator<CD> iter = wcds.iterator();
       while (iter.hasNext())
       {
       ...
       Test.execute(ls);
       Song longestSong = ls.getLongestSong();
       
       System.out.println("Longest song: " + longestSong.getTitle() + ", Length: " + longestSong.getLength());
       System.out.println();
